...
<#
.SYNOPSIS
Decline updates for editions of Office 365 ProPlus your organization does not support.
.DESCRIPTION
Decline updates for editions of Office 365 ProPlus your organization does not support.  If the LatestVersionOnly is left to its default value of True then for each edition only the latest version will be retained and all others declined.
.NOTES
