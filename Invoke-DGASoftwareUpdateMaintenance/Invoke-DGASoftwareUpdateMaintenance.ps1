...
Function Test-Exlusions {
##########################################################################################################
<#
.SYNOPSIS
   Determine if the update should be exluded or not.

.DESCRIPTION
   Compare the update metadata against the exlusion filters and return true if the update should be 
   exluded and return false if not.
...
#Confirm that the string arrays are properly processd.
